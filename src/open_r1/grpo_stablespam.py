...
def main(script_args, training_args, model_args):
    ...
    optimizer = StableSPAM(optimizer_grouped_parameters, lr=learning_rate_value, gamma1=training_args.stablespam_gamma1, gamma2=training_args.stablespam_gamma2, gamma3=0.999, update_proj_gap=training_args.stablespam_reset_gap) # total_T=total_T
